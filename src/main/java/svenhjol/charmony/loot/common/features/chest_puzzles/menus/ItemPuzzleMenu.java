package svenhjol.charmony.loot.common.features.chest_puzzles.menus;
...
import svenhjol.charmony.loot.common.features.chest_puzzles.Constants;
import svenhjol.charmony.loot.common.features.chest_puzzles.ItemPuzzleSlot;
...
public class ItemPuzzleMenu extends ContainerMenu implements ChestPuzzleMenu {
    ...
    public boolean clickMenuButton(Player player, int id) {
        access.execute((level, pos) -> {
            ...
            if (level instanceof ServerLevel serverLevel && serverLevel.getBlockEntity(pos) instanceof StoneChestBlockEntity chest) {
